...
public class Vec {
    ...
    // TODO change the arithmetic methods? they must return this
    ...
    public static Vec mul(Vec a, double k) {
        return new Vec (a.getX() * k, a.getY() * k);
    }

    public static Vec div(Vec a, double k) {
        return new Vec (a.getX() / k, a.getY() / k);
    }

    public static Vec bezier(Vec p1, Vec p2, Vec p3, Vec p4, double k) {
